# Nexlayer — postgres-notes

**Live:** [https://xenial-tern-postgres-notes.qa.cluster.vibeship.work](https://xenial-tern-postgres-notes.qa.cluster.vibeship.work)  
...
**postgres-notes** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01krc1n44dd49btzyv6vht92v2/postgres-notes:1a07da36756"
      path: /
      servicePorts:
        - 8080
      vars:
    ...
    - name: postgres
      ...
      vars:
        ...
        PGDATA: /var/lib/postgresql/data/pgdata
      volumes:
        - name: postgres-notes-postgres-data
          size: 10Gi
          mountPath: /var/lib/postgresql/data
```
